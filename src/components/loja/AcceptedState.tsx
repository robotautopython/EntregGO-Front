    ...
    >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="mt-2 text-2xl font-black text-asphalt-950">
                Entrega aceita por {delivery.courier.name}
              </h2>
      ...
      <Card variant="paper">
        <div className="flex items-start gap-3 text-sm text-asphalt-950/75">
          ...
          <p>
            O EntregGO mostra as etapas conforme o motoboy atualiza a entrega na rua. Use esta
            linha do tempo para acompanhar aceite, coleta, trajeto e conclusão.
          </p>
        </div>
      </Card>
    </section>
